...
with c1:
    ...
    st.page_link("pages/1_Business_Stats.py", label="👉 Open Dashboard", use_container_width=True)
...
with c2:
    ...
    st.page_link("pages/2_Revenue_Stats.py", label="👉 Open Dashboard", use_container_width=True)
...
with c3:
    ...
    st.page_link("pages/3_Purchase_Orders.py", label="👉 Open Dashboard", use_container_width=True)
...
with c4:
    ...
    st.page_link("pages/4_Product_Stats.py", label="👉 Open Dashboard", use_container_width=True)
st.markdown("<br>", unsafe_allow_html=True)
